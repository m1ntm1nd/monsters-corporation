...
def main():
    ...
    net2 = ie.read_network(model="/home/fuse-power/github/monsters-corporation/emotions-recognition-retail-0003/FP16-INT8/emotions-recognition-retail-0003.xml")
    ...
    while True:
        ...
        ret, frame = cap.read()
        frame = detect_face(frame, exec_net, input_blob, out_blob)
        frame = recognize_smile(frame, exec_net2, input_blob2, out_blob2)
